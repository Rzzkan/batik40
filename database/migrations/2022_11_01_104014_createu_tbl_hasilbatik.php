...
class CreateuTblHasilbatik extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_hasilbatik', function (Blueprint $table) {
            ...
            $table->string('warna1');
            $table->integer('jumlah_warna1');
            $table->string('warna2');
            $table->integer('jumlah_warna2');
            $table->string('warna3');
            $table->integer('jumlah_warna3');
            $table->string('warnaBg');
            $table->integer('jumlah_warnabg');
