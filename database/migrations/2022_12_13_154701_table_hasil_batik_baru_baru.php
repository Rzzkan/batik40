...
class TableHasilBatikBaruBaru extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('tbl_hasilbatik', function (Blueprint $table) {
            ...
            $table->integer('jumlah_warna1')->nullable();
            $table->string('warna2')->nullable();
            $table->integer('jumlah_warna2')->nullable();
            $table->string('warna3')->nullable();
            $table->integer('jumlah_warna3')->nullable();
            $table->string('warnaBg')->nullable();
            $table->integer('jumlah_warnabg')->nullable();
