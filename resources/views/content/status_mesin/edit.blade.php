            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <strong><i class="far fa-hdd mr-2"> </i> Form Status Mesin - Edit {{ $mesin->nama }} </strong><a href="{{ url()->previous() }}" class="btn btn-danger btn-sm ml-auto"><i class="fas fa-arrow-left mr-2"> </i> Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <form class="col" method="POST" action="{{ route('status_mesin.update', $mesin->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
